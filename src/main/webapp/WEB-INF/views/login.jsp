    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="row social-button-row">
                <div class="col-lg-4">
                    <a href="${pageContext.request.contextPath}/auth/google"><button class="btn btn-google"><i class="icon-google"></i> | <spring:message code="label.google.sign.in.button"/></button></a>
                </div>
            </div>
            <div class="row social-button-row">
                <div class="col-lg-4">
